...
for epsilon in epsilon_values:
    ...
    filtered_implicit_error_dataframes.append(error_FUW_table)
...
f2_ax1.plot(error_FUW_table["dx"].tolist(), error_FUW_table["t=1.0"].tolist())
f2_ax1.plot(error_UW_table["dx"].tolist(), error_UW_table["t=1.0"].tolist())
plt.legend(["Filtered Upwind", "Upwind"])
